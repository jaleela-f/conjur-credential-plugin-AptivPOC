...
/**
 * ConjurAPI class will provide the below functionality to retrieve the secrets from Conjur through
 * RESTApi calls 
 * <li>Retrieve authentication parameters defined as Environment variable</li>
 * <li> Retrieve Authorization token 
 * 
